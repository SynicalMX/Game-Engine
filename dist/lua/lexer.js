        ...
        if (isNumeric(code[index])) {
            ...
            switch (code[index]) {
                ...
                case '\n':
                    ...
                    break;
                case '.':
                    match('.') ? addToken('DOT_DOT') : addToken('DOT');
                    break;
                case ',':
                    addToken('COMMA');
                    break;
                case '=':
                    match('=') ? addToken('EQUALS_EQUALS') : addToken('EQUALS');
                    break;
                case '~':
                    match('=') ? addToken('NOT_EQUALS') : error(line, 'Unexpected character ~');
                    break;
                case '+':
                    addToken('PLUS');
                    break;
                ...
                case '/':
                    ...
                    break;
                case '<':
                    match('=') ? addToken('LESS_EQUALS') : addToken('LESS');
                    break;
                case '>':
                    match('=') ? addToken('GREATER_EQUALS') : addToken('LESS_EQUALS');
                    break;
                //grouping
                case '(':
                    addToken('OPEN_PAREN');
                ...
                case ')':
                    ...
                    break;
                case '[':
                    addToken('OPEN_SQUARE');
                    break;
                case ']':
                    addToken('CLOSE_SQUARE');
                    break;
                case '{':
                    addToken('OPEN_CURLY');
                    break;
                case '}':
                    addToken('CLOSE_CURLY');
                    break;
